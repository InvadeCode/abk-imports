    ...
    >
      ...
      <div
        className={`flex items-center gap-6 md:gap-8 ${
          !scrolled && currentPage === 'Home' ? 'text-white' : 'text-black'
        }`}
      >
        <button
          onClick={onOpenMenu}
          className="flex items-center gap-2 hover:text-[#E60000] transition-colors group"
        >
          <span className="hidden md:block text-sm font-semibold uppercase tracking-widest mt-1 group-hover:text-[#E60000] transition-colors">
            Menu
          </span>
...
const FullScreenMenu = ({ isOpen, onClose, setCurrentPage }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[90000] bg-[#111] text-white flex flex-col transition-transform duration-[0.8s] ease-[cubic-bezier(0.77,0,0.175,1)] ${
        isOpen ? 'translate-y-0' : '-translate-y-full'
      }`}
    >
      <div className="px-[4vw] py-6 flex justify-between items-center border-b border-white/10">
        <img
          src="https://abkimports.com/wp-content/uploads/2023/04/ABK-Logo_150pix-x-150pix-01.png"
          alt="ABK Imports Logo"
        ...
        <button
          onClick={onClose}
          className="p-2 hover:text-[#E60000] transition-colors hover:rotate-90 duration-300"
        >
      ...
      <div className="flex-1 flex flex-col md:flex-row px-[4vw] py-12 md:py-20 h-full overflow-y-auto">
        ...
        <div
          className={`mt-16 md:mt-0 flex-1 flex flex-col justify-end md:items-end transition-opacity duration-1000 delay-500 ${
  ...
  if (!brand) {
    return (
      <div className="pt-32 px-10 min-h-screen text-center">
        <h1 className="text-4xl font-heading font-bold mb-4 mt-20">Brand Profile Not Found</h1>
